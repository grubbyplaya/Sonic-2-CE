...
LABEL_B28_A3F4:
	...
	bit     6, (ix+$04)
	jr      nz, +_
_:	ld      e, (ix+$18)		;get vertical velocity
	ld      d, (ix+$19)
	...
	jp      c, +_
	ld      hl, $0000
_:	ld      (ix+$18), l		;set vertical velocity
	ld      (ix+$19), h
LABEL_B28_A42C:
_:	ld      h, (ix+$12)		;get horizontal pos
	ld      l, (ix+$11)
	ld      de, $0DA0
	xor     a
	sbc     hl, de
	...
	pop     iy
	ld      (iy+$02), $07
_:	jp      VF_Engine_DisplayExplosionObject
...
UGZ3_Robotnik_State_07_Logic_01:		;$A6CA
	...
	jr      z, +_
	ld      hl, $0280
_:	ld      (ix+$16), l		;set horizontal velocity
	ld      (ix+$17), h
	call    VF_Engine_UpdateObjectPosition
